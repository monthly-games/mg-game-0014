...
const kWitchMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/witch/witch.json',
...
const kGolemMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/golem/golem.json',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
...
const kFamiliarMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/familiar/familiar.json',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
